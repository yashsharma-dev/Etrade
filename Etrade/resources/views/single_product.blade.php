...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/single-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2024 04:38:16 GMT -->
                                    ...
                                    <div class="row row--10">
                                        <div class="col-6 mb--20">
                                            <div class="single-product-thumbnail axil-product thumbnail-grid">
                                                <div class="thumbnail">
                                                    <img class="img-fluid" src="{{asset('storage/kartik_images/'.$row->pr_image)}}" alt="Product Images">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- End .col -->
                            ...
                            <div class="h-100">
                                <div class="position-sticky sticky-top">
                                    <div class="single-product-content">
                                        <div class="inner">
                                            <h2 class="product-title">{{$row->pr_name}}</h2>
                                            <span class="price-amount">${{$row->pr_sale_price}} - ${{$row->pr_price}}</span>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/single-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Jul 2024 04:38:20 GMT -->
</html>